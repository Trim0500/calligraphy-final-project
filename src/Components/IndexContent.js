            ...
            <div className="row">
                <div className="mx-auto col-md-10">
                    <Container>
                        ...
                        <img class="mx-auto d-block" src={ logo } alt="Serene Flourish Logo" width="926" height="400" />
                            <Row>
                                <Col>
                                    <Nav.Link href="/form" name="calligraphy-img"><img class="mx-auto d-block"  src={ card } width="200" height="200" /></Nav.Link>
                                    <h6 style={{textAlign: "center"}}>Calligraphy</h6>
                                    <p style={{textAlign: "center"}}>From pencil to marker to paint</p>
                                </Col>
                                <Col>
                                    <Nav.Link href="/form" name="engraving-img"><img class="mx-auto d-block" src={ gin } width="200" height="200" /></Nav.Link>
                                    <h6 style={{textAlign: "center"}}>Engraving</h6>
                                    <p style={{textAlign: "center"}}>From bottles to laptops</p>
                                </Col>
                                <Col>
                                    <Nav.Link href="/form" name="event-img"><img class="mx-auto d-block" src={ live }  width="200" height="200" /></Nav.Link>
