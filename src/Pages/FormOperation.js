                ...
                <Card.Body style={bodyStyle}>
                    ...
                    <div className={'d-flex justify-content-center'}>
                        <div className={'d-inline-flex'}>
                            <button className={'btn-primary  m-1 rounded-2'} onClick={previousPage}>{t("previousBtn")}</button>
                            <select id="pageSelector" className={'w-50  m-1 rounded-2'} onChange={selectPage}>
                                {[...Array(totalPages)].map((x, i) =>
                                    <option key={i} value={i + 1}>{i + 1}</option>
                                )}
                            </select>
                            <button className={'btn-primary  m-1 rounded-2'} onClick={nextPage}>{t("nextBtn")}</button>
                            <button className={'btn-primary  m-1 rounded-2'} onClick={lastPage}>{t("lastBtn")}</button>
                        </div>
                    </div>
                </Card.Body>
            </Card>
